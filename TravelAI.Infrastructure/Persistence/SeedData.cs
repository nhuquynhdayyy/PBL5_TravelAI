...
public static class SeedData
{
    public static async Task InitializeAsync(ApplicationDbContext context)
    {
        ...
        var destinations = new List<Destination>
        {
            ...
            new Destination { Name = "Quảng Ninh (Hạ Long)", Description = "Kỳ quan thiên nhiên thế giới.", ImageUrl = "https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?q=80&w=1000", Categories = "Biển,Trải nghiệm",
            ...
            new Destination { Name = "Kiên Giang (Phú Quốc)", Description = "Đảo ngọc với những bãi cát trắng mịn.", ImageUrl = "https://images.unsplash.com/photo-1589785834420-72782b14686c?q=80&w=1000", Categories = "Biển,Trải nghiệm",
            ...
            new Destination { Name = "Thừa Thiên Huế", Description = "Cố đô tĩnh lặng và mộng mơ.", ImageUrl = "https://images.unsplash.com/photo-1585123334904-845d60e97b29?q=80&w=1000", Categories = "Lịch sử,Văn hóa",
            ...
            new Destination { Name = "Quảng Nam (Hội An)", Description = "Phố cổ lung linh với lồng đèn.", ImageUrl = "https://images.unsplash.com/photo-1599708153386-62e245789645?q=80&w=1000", Categories = "Lịch sử,Văn hóa",
            ...
            new Destination { Name = "Lào Cai (Sapa)", Description = "Thị trấn trong sương với ruộng bậc thang kỳ vĩ.", ImageUrl = "https://images.unsplash.com/photo-1508804494830-d331593c18f9?q=80&w=1000", Categories = "Núi rừng,Văn hóa",
            ...
            new Destination { Name = "Khánh Hòa (Nha Trang)", Description = "Vịnh biển đẹp bậc nhất hành tinh.", ImageUrl = "https://images.unsplash.com/photo-1583417319070-4a69db38a482?q=80&w=1000", Categories = "Biển,Trải nghiệm",
